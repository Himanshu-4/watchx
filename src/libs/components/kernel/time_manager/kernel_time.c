              ...
              current_time.minutes = 0;
                ...
                if (current_time.hour > KERNEL_TIME_HOUR_MAX) {
                  ...
                  current_date.date++;
                    ...
                    if (current_date.date > (GET_REMNDER(current_date.year, LEAP_YEAR_BASE_NUMBER)
                                               ? (kernel_months_max_Days[current_date.month])
                                               : (kernel_months_max_Days_leap_year[current_date.month]))) {
                      current_date.date = 1;
