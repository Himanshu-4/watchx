...
// if you want to protect your aPP from being copied , modified , change  use thhis 
    ...
    /// enable the irq handlers for hardfault memmanage fault and sysfault
    #if defined(ENABLE_FAULT_HANDLERS)
    extern void enable_fault_handlers(void);
